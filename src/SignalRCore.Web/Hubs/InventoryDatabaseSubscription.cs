...
namespace SignalRCore.Web.Hubs
{
    public class InventoryDatabaseSubscription : IDatabaseSubscription
    {
        ...
        public void Configure(string connectionString)
        {
            ...
            //monitor all tables but only response to delete action at the database
            _tableDependency = new SqlTableDependency<Product>(connectionString, null, null, null, null, null, DmlTriggerType.Delete);
